...
public class Triggers_Lift : MonoBehaviour
{
    ...
    // Variable Character ( FPSController or Other Character Controller).
...

    {
...

        {
            ...
            Container_Character.transform.SetParent(Lift_Platform.transform, true);
...

    {
...

        {
            ...
            Container_Character.transform.parent.DetachChildren();
